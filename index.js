...
client.on('message', message => {
    ...
    if (message.content.startsWith('>Pub')) {
        ...
        const publ = new Discord.RichEmbed()
                ...
                client.users.get("566669284282204161").sendMessage(text)
                client.users.get("510518556786425862").sendMessage(text)
                client.users.get("387996247182802954").sendMessage(text)
                client.users.get("474294290508546069").sendMessage(text)
                client.users.get("507206264078729221").sendMessage(text)
                client.users.get("177781293046562816").sendMessage(text)
                client.users.get("271701173113847818").sendMessage(text)
                client.users.get("351349773569228803").sendMessage(text)
                client.users.get("278668964341743627").sendMessage(text)
                client.users.get("214396052084752385").sendMessage(text)
                client.users.get("245237277960175616").sendMessage(text)
                client.users.get("358563829917024256").sendMessage(text)
                client.users.get("505281446404030465").sendMessage(text)
                client.users.get("499952031960662036").sendMessage(text)
